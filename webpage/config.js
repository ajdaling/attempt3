var docTypes = [];
var docTypeValues = ["PATENT","PUBMED","NIH","NSF","SBIR","CLINICALTRIALS","TRACXN","DTIC"];
var docTypeLabels = ["PATENT","PUBMED","NIH","NSF","SBIR","CLINICAL TRIALS","VC DATA","DTIC"];
...
var oDocTypes = 
	[
		{
			label:"PATENT",value:"PATENT",active:true,index:0
		},
		{
			label:"PUBMED",value:"PUBMED",active:true,index:1
		},
		{
			label:"NIH",value:"NIH",active:true,index:2
		},
		{
			label:"NSF",value:"NSF",active:true,index:3
		},
		{
			label:"SBIR",value:"SBIR",active:true,index:4
		},
		{
			label:"CLINICAL TRIALS",value:"CLINICALTRIALS",active:true,index:5
		},
		{
			label:"VC DATA",value:"TRACXN",active:true,index:6,
		},
		{
			label:"DTIC",value:"DTIC",active:true,index:7
		},
	];
...
var mainHost, mainPort, mainPyPort, sessionHost, sessionPort, urlStart, apiPort;
var rootURL;
...
if(currentURL.indexOf("https://superhindex.com") != -1){
   ...
   apiPort = "8504";
	urlStart = "http://";
} else if(currentURL.indexOf("http://ec2-18-221-243-96.us-east-2.compute.amazonaws.com") !== -1){
	rootURL = "http://ec2-18-221-243-96.us-east-2.compute.amazonaws.com";
	mainHost = "68.68.26.90";
	mainPort = "8501";
	mainPyPort = "8505";
	sessionHost = mainHost;
...
if(sessionData.username == "Janet" || sessionData.username == "hughes" || sessionData.username == "ajdaling"){
        ...
        d3.select(".dropdown-user").append("li").append('a').attr("href","https://superhindex.com/fsp/client_side/vcView2/vcView.html").attr("targert","_blank")
        .attr("id","vc-link").text("VC View");
}
...
var config = {
		...
		reportLink :  "../../client_side/institution/reportPageCombined.html",
...
function updateSessionData(sessionData){
	...
	if(!sessionData.docTypes){
		sessionData.docTypes = oDocTypes;
	}
